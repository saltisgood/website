...
$para = new Paragraph();
$para->text = 'This is the help page for OpenSnap and will show you how to use the app to its full potential.';
...
$sec->heading = 'Login';
$para = new Paragraph();
$para->text = 'When you first start the app this is what you see. You login with your normal SnapChat username and password.
...
$sec->heading = 'Home';
$para = new Paragraph();
$para->text = 'Once you login you\'re brought to the home page, which you can see below. Here you have 3 buttons to take
...
$para = new Paragraph();
$para->text = 'Users with phones with a hardware options button can click the options button to view the options popup,
whereas those without will see the overflow button in the right of the Action Bar.';
$sec->addParagraph($para);
$htmlOut->content->addSection($sec);

$sec = new ImageSection();
$sec->type = ImageSection::SCREENSHOT;

$img = new Image('img/opensnap_home_small.gif', 169, 300);
$img->setAltLink('img/opensnap_home.gif');
$img->setAltText('The Home Page');
$img->setCaption('The Home Page');
$sec->addImage($img);

$htmlOut->content->addImageSection($sec);

$sec = new Section();
$sec->heading = 'The Snaplist';
$para = new Paragraph();
$para->text = 'All your snaps are saved in a list like the one in the picture. Each snap has an icon to the left which
...
$sec->addParagraph($para);
$para = new Paragraph();
$para->text = 'When you want to download a snap you simply tap on the item in the list and it will show up a progress
...
$sec->addParagraph($para);
$para = new Paragraph();
$para->text = 'Snaps can also be long-clicked to get a pop-up with more specific options available, though those are fairly
bare bones at the moment.';
$sec->addParagraph($para);
$htmlOut->content->addSection($sec);

$sec = new Section();
$sec->heading = 'Contacts';
$para = new Paragraph();
$para->text = 'Your contacts are also saved in a list much like the snaps. They\'re displayed in alphabetical order of
...
$para = new Paragraph();
$para->text = 'Tap a contact\'s name to view the thread of snaps sent and received between yourself and them. This thread
...
$sec = new Section();
$sec->heading = 'New Snaps';
$para = new Paragraph();
$para->text = 'So you want to take a snap, click on the new snap button in the home page. You then have 4 options,
opensnap camera, resend, select from library and android camera.';
$sec->addParagraph($para);

$para = new Paragraph();
$para->text = 'OpenSnap Camera is to take a picture with the camera built into OpenSnap. Though there are less options
than the Android camera it will automatically choose the correct picture size and is pretty fast. Use this
unless you have a reason not to.';
$sec->addParagraph($para);

$para = new Paragraph();
$para->text = 'The resend button will be grayed out unless you\'ve previously sent a snap. In that case you can select it
to go back to the editing screen with that other snap and modify or send it again.';
$sec->addParagraph($para);

$para = new Paragraph();
$para->text = 'Select from library allows you to send a picture that is currently stored in your android gallery. So
...
$para = new Paragraph();
$para->text = 'Android camera is to take a picture with your phone\'s default camera app. This allows you to have more
control over the end result if you really want to.';
$sec->addParagraph($para);

$para = new Paragraph();
$para->text = 'Once you\'ve taken a snap in some way you\'ll get taken to the snap editor.';
$sec->addParagraph($para);
$htmlOut->content->addSection($sec);

$sec = new Section();
$sec->heading = 'Snap Editor';
$para = new Paragraph();
$para->text = 'The editor is just as fully featured as the SnapChat version. Tap on the snap to the make a caption, drag
...
$sec = new Section();
$sec->heading = 'Contact Selector';
$para = new Paragraph();
$para->text = 'Now you\'re ready to send your snap. You can drag from the very left of the screen to view a preview of
